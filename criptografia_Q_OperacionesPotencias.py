...
#######################################################################################
def generaOperacionesTipo1(exponenteSolucion, numeroOperacionesDistintas, maximoPositivo, minimoNegativo):
...
def generaOperacionesTipo2(exponenteSolucion, numeroOperacionesDistintas, maximoPositivo, minimoNegativo):
...
def generaOperacionesTipo3(exponenteSolucion, numeroOperacionesDistintas, maximoPositivo, minimoNegativo):
...
def generaOperacionesTipo4(exponenteSolucion, numeroOperacionesDistintas, maximoPositivo, minimoNegativo):
...
def generaOperacionesTipo5(exponenteSolucion, numeroOperacionesDistintas, maximoPositivo, minimoNegativo):
...
def generaOperacionesTipo6(exponenteSolucion, numeroOperacionesDistintas, maximoPositivo, minimoNegativo):
...
def generaOperacionesTipo7(exponenteSolucion, numeroOperacionesDistintas, maximoPositivo, minimoNegativo):
    # (factor1^exp1)/(factor2^exp2)·(1/factor1^exp3)·factor2^-exp4 OK
    contador = 0
    listaOperaciones = []
    while contador < numeroOperacionesDistintas:
        factor1 = random.randrange(2,10) #ATENCIÓN: MEJOR SI NO ES CUADRADO NI CUBO PERFECTO
        posibilidadesFactor2 = [2*factor1-1,2*factor1+1,2*factor1+3] # Primos con factor1
        factor2 = posibilidadesFactor2[random.randrange(0,len(posibilidadesFactor2))]
        exp1 = random.randrange(minimoNegativo, maximoPositivo)
        exp2 = random.randrange(minimoNegativo, maximoPositivo)
...
def generaOperacionesTipo8(exponenteSolucion, numeroOperacionesDistintas, maximoPositivo, minimoNegativo):
...
#            fLaTeX.write(convierteLetraAOperacion(operacionesDistintas[papa],numeroOperacionesDistintas,codigoAlfabetico.get(elementos[koko][papa]),maximoPositivo, minimoNegativo)[0]+r" & & \\\hline"+"\n")
            #----------------------------------------------
