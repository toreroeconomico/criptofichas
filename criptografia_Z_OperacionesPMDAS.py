...
#######################################################################################
def generaOperacionesTipo1(resultadoOperacion, numeroOperacionesDistintas, maximoPositivo, minimoNegativo):
    # 3·(-5)+(-5)·(-2)=
    contador = 0
    listaOperaciones = []
...
def generaOperacionesTipo2(resultadoOperacion, numeroOperacionesDistintas, maximoPositivo, minimoNegativo):
    # 3+(-5)+(-5)-(-2)=
    contador = 0
    listaOperaciones = []
    while contador < numeroOperacionesDistintas:
        ...
        n3 = random.randrange(minimoNegativo, -1)
        if p1+n1+n2-n3 == resultadoOperacion:
            textoOperacion = "$" + str(p1) + "+" + "(" + str(n1) + ")" + "+" + "(" + str(n2) + ")" + "-" + "(" + str(n3) + ")" + "$"
            listaOperaciones.append(textoOperacion)
            listaOperacionesUnicas = np.unique(listaOperaciones)
            contador = len(listaOperacionesUnicas)
    return listaOperacionesUnicas
...
def generaOperacionesTipo3(resultadoOperacion, numeroOperacionesDistintas, maximoPositivo, minimoNegativo):
    # 3·[7+(-5)-(-4)]+6=
    contador = 0
    listaOperaciones = []
    while contador < numeroOperacionesDistintas:
...
def generaOperacionesTipo4(resultadoOperacion, numeroOperacionesDistintas, maximoPositivo, minimoNegativo):
    # -3-(-5)+4·(-2)=
    contador = 0
    listaOperaciones = []
    while contador < numeroOperacionesDistintas:
        ...
        if n1-n2+p1*n3 == resultadoOperacion:
            textoOperacion = "$" + str(n1) + "-" + "(" + str(n2) + ")" + "+" + str(p1) + "\cdot{}" + "(" + str(n3) + ")" + "$"
            listaOperaciones.append(textoOperacion)
            listaOperacionesUnicas = np.unique(listaOperaciones)
            contador = len(listaOperacionesUnicas)
    return listaOperacionesUnicas
...
def generaOperacionesTipo5(resultadoOperacion, numeroOperacionesDistintas, maximoPositivo, minimoNegativo):
    # -3+(-5):(-2)+4:5·(-4)+3=
    contador = 0
    listaOperaciones = []
    while contador < numeroOperacionesDistintas:
...
def generaOperacionesTipo6(resultadoOperacion, numeroOperacionesDistintas, maximoPositivo, minimoNegativo):
    # -3+(-5)·(-2)=
    contador = 0
    listaOperaciones = []
    while contador < numeroOperacionesDistintas:
        ...
        if n1+n2*n3 == resultadoOperacion:
            textoOperacion = "$" + str(n1) + "+" + "(" + str(n2) + ")" + "\cdot{}" + "(" + str(n3) + ")" + "$"
            listaOperaciones.append(textoOperacion)
            listaOperacionesUnicas = np.unique(listaOperaciones)
            contador = len(listaOperacionesUnicas)
    return listaOperacionesUnicas

def generaOperacionesTipo7(resultadoOperacion, numeroOperacionesDistintas, maximoPositivo, minimoNegativo):
    # 7+(-5)-(-2)=
    contador = 0
    listaOperaciones = []
    while contador < numeroOperacionesDistintas:
        ...
        if p1+n1-n2 == resultadoOperacion:
            textoOperacion = "$" + str(p1) + "+" + "(" + str(n1) + ")" + "-" + "(" + str(n2) + ")" + "$"
            listaOperaciones.append(textoOperacion)
            listaOperacionesUnicas = np.unique(listaOperaciones)
            contador = len(listaOperacionesUnicas)
    return listaOperacionesUnicas

def generaOperacionesTipo8(resultadoOperacion, numeroOperacionesDistintas, maximoPositivo, minimoNegativo):
    # -7+4+(-5):(-2)=
    contador = 0
    listaOperaciones = []
    while contador < numeroOperacionesDistintas:
...
def generaOperacionesTipo9(resultadoOperacion, numeroOperacionesDistintas, maximoPositivo, minimoNegativo):
    # 4·(-7)-(-5)=
    contador = 0
    listaOperaciones = []
    while contador < numeroOperacionesDistintas:
        ...
        n2 = random.randrange(minimoNegativo, -1)
        if p1*n1-n2 == resultadoOperacion:
            textoOperacion = "$" + str(p1) + r"\cdot{}" + "(" + str(n1) + ")" + "-" + "(" + str(n2) + ")" + "$"
            listaOperaciones.append(textoOperacion)
            listaOperacionesUnicas = np.unique(listaOperaciones)
            contador = len(listaOperacionesUnicas)
    return listaOperacionesUnicas
...
for koko in range(len(elementos)):
    ...
    for papa in range(len(elementos[koko])):
        ...
        if codigoAlfabetico.get(elementos[koko][papa]) is not None:
            #----------------------------------------------
            exec("cadenas = generaOperacionesTipo" + str(operacionesDistintas[papa]+1) + "(codigoAlfabetico.get(elementos[koko][papa]), numeroOperacionesDistintas, maximoPositivo, minimoNegativo)")
